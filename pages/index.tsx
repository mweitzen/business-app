    ...
    <div>
      ...
      <div className="mb-2 grid gap-8 text-center text-sm">
        ...
        <div className="flex flex-col">
          <Link href="/admin">
            <CardBase className="shadow-purple-300">
              <div className="relative mb-4 flex items-center justify-center gap-2">
                ...
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="absolute right-0 top-0 h-6 w-6 text-purple-200"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <p>
                An administrative overview of the organization. Access is
                limited to those with admin priviliges. Beyond admin privileges,
                additional access to each resource is limited to who gets
                assigend access.
              </p>
            </CardBase>
          </Link>
