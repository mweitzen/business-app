...
const Topbar = () => {
  ...
  return (
    <header className="relative z-20 flex h-12 w-full items-center justify-between bg-element px-5 font-medium text-gray-800 shadow shadow-purple-300 dark:text-gray-100 dark:shadow-gray-800 sm:h-14 sm:px-8">
      {/* left */}
